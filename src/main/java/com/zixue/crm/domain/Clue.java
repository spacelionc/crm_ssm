...
public class Clue {
	...
	public String toString() {
		return "Clue [id=" + id + ", fullname=" + fullname + ", appellation=" + appellation + ", owner=" + owner
				+ ", company=" + company + ", job=" + job + ", email=" + email + ", phone=" + phone + ", website="
				+ website + ", mphone=" + mphone + ", state=" + state + ", source=" + source + ", createBy=" + createBy
